...
class Message:
    ...
    def __init__(self,db_data):
        ...
        # self.message_id = db_data['message_id']
    ...
    def get_user_messages(cls,data):
        # query = "SELECT * FROM messages JOIN users ON messages.id = message_id WHERE user_id = 1"
...
#         query = "SELECT users.first_name as sender, users2.first_name as receiver
